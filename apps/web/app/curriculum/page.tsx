...
export default function CurriculumPage() {
  ...
  useEffect(() => {
    fetch("/api/v1/curriculum/tree")
      ...
      .then((tree: CurriculumNode) => {
        setRoot(tree);
        const firstVolume = tree.node_type === "volume"
          ? tree
          : tree.children.find((item) => item.node_type === "volume");
  ...
  return <div className="page-content">
    ...
    <div className="curriculum-grid">
      {chapters.map((chapter) => <article className="curriculum-card" key={chapter.node_id}>
